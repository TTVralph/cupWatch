  ...
  return (
    <main className="page-container cw-page text-slate-100">
      <div className="cw-shell">
        <GlassPanel className="mb-6 p-5 md:p-10">
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="cw-kicker">{eyebrow}</p>
              <h1 className="cw-title mt-3 max-w-3xl text-3xl md:text-5xl">{title}</h1>
              <p className="cw-muted mt-3 max-w-2xl text-sm leading-6 md:text-base">{description}</p>
            </div>
